...
```
# Histogram of Institutional Research Spending Fiscal Year 2022
# By Colin Thompson
...
# Total Enrollment by Research Tier (2020-2023)
# By Mia Leandri 

This visualization presents a boxplot comparison of total student enrollment across different research tiers—specifically, Research 1 (R1), Research 2 (R2), and Research Colleges and Universities. The goal of this chart is to examine institutional size as a distinguishing characteristic among these tiers, contributing to a broader descriptive and comparative analysis of higher education institutions.

By plotting the distribution of enrollment values within each tier, the chart reveals key patterns in scale, central tendency (median), and variability. The boxplot format displays the interquartile range (IQR), median enrollment, and potential outliers, enabling the viewer to assess both typical and extreme enrollment figures.

This visualization is particularly valuable in supporting descriptive and comparative research questions about the U.S. higher education system. It allows stakeholders—such as policymakers, academic researchers, and institutional planners—to:

  -Understand how research classification correlates with institutional size.
  -Identify structural differences between tiers that may influence funding, admissions, staffing, and infrastructure.
  -Establish a baseline for benchmarking or resource planning across similar or aspirational peer institutions.
...
# Average Research Spending vs. Doctoral Degrees by Research Tier (2020–2023) 
# By Mia Leandri
